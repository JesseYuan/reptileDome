...
public class MyCrawler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //crawler.crawling(new String[]{"https://image.baidu.com/search/index?tn=baiduimage&ct=201326592&lm=-1&cl=2&ie=gbk&word=%B2%BB%B2%C5&fr=ala&ala=1&alatpl=adress&pos=0&hs=2&xthttps=111111"});
        Test.getImage();
    }
}
